...
export function JustifyContent() {
  return (
    <>
      <h1 className="text-primary-500 ta-center py-16">Justify Content Utilities</h1>
  ...
  justify-content: center;
      ...
      <p className="fw-600 mb-12 py-8 px-16 bg-neutral-50">Available Classes & Generated Properties</p>
      ...
      <div className="d-flex flex-wrap ai-center mb-12 px-16 g-8">
        {justifyContentValues.map((justification) => {
          return <ValueWrapper key={justification}>{justification}</ValueWrapper>;
        })}
      </div>
      <p className="fw-600 mb-12 py-8 px-16 bg-neutral-50">Available Breakpoints</p>
